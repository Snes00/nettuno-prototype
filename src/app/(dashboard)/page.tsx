      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div className="md:col-span-8 bg-[#DCFCE7] rounded-[1.5rem] p-8 md:p-10 min-h-[320px] flex flex-col justify-between group border-none shadow-none">
          <div className="flex justify-between items-start">
             <div className="space-y-1">
                ...
                <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-[#166534] leading-[0.95]">Pittura e Arti <br />Visive I</h2>
             </div>
             <div className="h-12 w-12 rounded-xl bg-[#166534]/10 flex items-center justify-center">
        ...
        <div className="md:col-span-12 bg-[#FEE2E2] rounded-[1.5rem] p-8 md:p-10 flex flex-col gap-6 border-none shadow-none">
           ...
           <div className="flex justify-center md:justify-end mt-2">
              <Button className="rounded-xl bg-[#991b1b] text-white hover:bg-[#991b1b]/90 font-black px-8 h-12 gap-2 shadow-none text-sm">
                 Tutti gli avvisi (12)
