...
<TabsTrigger value="esami" className="flex-1 rounded-xl py-3 gap-2 font-black text-[10px] uppercase tracking-widest transition-all active:scale-95">
        ...
        <TabsContent value="esami" className="mt-0 focus-visible:outline-none">
          {creaAppello ? (
            <div className="bg-card rounded-[2rem] p-6 md:p-8 space-y-10 border border-border/40 md:border-none shadow-none">
              <div className="flex items-center gap-4">
                <Button variant="ghost" onClick={() => setCreaAppello(false)} className=" h-11 px-5 font-black uppercase tracking-widest text-[10px] text-muted-foreground hover:text-foreground hover:bg-muted/40 transition-all">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select className="w-full h-14 rounded-[1.5rem] bg-muted/20 border-none px-4 font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20">
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="es. Aula 12" className="h-14 rounded-[1.5rem] bg-muted/20 border-none focus-visible:ring-primary/20 font-bold" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Data</Label>
                  <Input type="date" className="h-14 rounded-[1.5rem] bg-muted/20 border-none focus-visible:ring-primary/20 font-bold" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Orario</Label>
                  <Input type="time" className="h-14 rounded-[1.5rem] bg-muted/20 border-none focus-visible:ring-primary/20 font-bold" />
                </div>
                <div className="md:col-span-2 space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Commissione</Label>
                  <Input placeholder="es. Prof.ssa Elena Bianchi, Prof. Marco Verdi" className="h-14 rounded-[1.5rem] bg-muted/20 border-none focus-visible:ring-primary/20 font-bold" />
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 bg-card rounded-[2rem] p-10 space-y-10 border border-border/40 md:border-none shadow-none">
               <div className="flex items-center justify-between px-2">
                  <h3 className="text-2xl font-black tracking-tighter uppercase text-foreground">Appelli Sessione</h3>
                  <Button variant="ghost" onClick={() => setCreaAppello(true)} className="text-[10px] font-black uppercase tracking-[0.2em] text-primary hover:bg-primary/10  px-5 h-11 transition-all">Nuovo Appello <Plus className="ml-2 h-4 w-4" /></Button>
               </div>
                    ...
                    <div key={appello.id} className="p-8 bg-muted/20 rounded-[2rem] space-y-6 group hover:bg-muted/40 transition-all border border-transparent hover:border-border/10">
                       <div className="flex justify-between items-start">
                          <div className="flex items-center gap-5">
                             <div className={cn("h-14 w-14 rounded-full flex items-center justify-center text-foreground shadow-none", appello.role)}>
                       ...
                       <div className="flex justify-between items-center pt-2">
                          ...
                          <Button className=" bg-foreground text-background h-10 px-6 font-black text-[10px] uppercase tracking-widest shadow-none active:scale-95 transition-all">
                            Apri Verbale
                          </Button>
                       </div>
                    </div>
            ...
            <div className="lg:col-span-4 bg-role-accent rounded-[2rem] p-10 flex flex-col justify-between border border-role-accent-fg/10 shadow-none min-h-[400px] transition-all hover:scale-[1.01]">
               <div className="space-y-4">
                  <div className="h-16 w-16 rounded-full bg-role-accent-fg/10 flex items-center justify-center text-role-accent-fg">
               ...
               <div className="flex flex-col gap-4">
                  <Button className="w-full bg-role-accent-fg text-role-accent  h-16 font-black uppercase tracking-widest text-xs shadow-none hover:opacity-90 transition-all active:scale-95">Vai ai verbali</Button>
        ...
        <TabsContent value="tesi" className="mt-0 focus-visible:outline-none space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-role-accent rounded-[2rem] p-8 flex flex-col gap-4 cursor-pointer hover:scale-[1.02] transition-all border border-role-accent-fg/10">
              <div className="h-14 w-14 rounded-full bg-role-accent-fg/10 flex items-center justify-center">
            ...
            <div className="bg-role-warning rounded-[2rem] p-8 flex flex-col gap-4 cursor-pointer hover:scale-[1.02] transition-all border border-role-warning-fg/10">
              <div className="h-14 w-14 rounded-full bg-role-warning-fg/10 flex items-center justify-center">
              ...
              {[
                ...
                <div key={i} className="bg-card rounded-[2rem] p-8 space-y-6 border border-border/40 md:border-none shadow-none">
                  ...
                  <div className="flex gap-4">
                    <Button className=" h-12 px-8 bg-role-success-fg text-role-success font-black uppercase tracking-widest text-[10px] shadow-none active:scale-95">
                      <CheckCircle2 className="h-4 w-4 mr-2" /> Approva
                    </Button>
                    <Button variant="outline" className=" h-12 px-8 border-role-critical-fg/30 text-role-critical-fg hover:bg-role-critical/10 font-black uppercase tracking-widest text-[10px] active:scale-95">
              ...
              <div className="divide-y divide-border/20">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-6 hover:bg-muted/20 transition-colors group cursor-pointer">
                    <div className="flex items-center gap-5">
                      <div className="h-12 w-12 rounded-full bg-muted/30 flex items-center justify-center font-black text-xs text-muted-foreground group-hover:text-primary group-hover:bg-primary/10 transition-all">
        ...
        <TabsContent value="orario" className="mt-0 focus-visible:outline-none">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              {/* Griglia Oraria */}
              <div className="lg:col-span-8 bg-card rounded-[2rem] p-5 md:p-6 space-y-10 border border-border/40 md:border-none shadow-none">
                 <div className="grid grid-cols-7 gap-3">
                    ...
                    {Array.from({ length: 35 }, (_, i) => (
                       <div key={i} className="aspect-square rounded-[1.5rem] bg-muted/20 border border-muted/5 flex items-center justify-center relative transition-colors hover:bg-muted/30 cursor-pointer">
              ...
              <div className="lg:col-span-4 space-y-8">
                <div className="bg-card rounded-[2rem] p-10 space-y-10 border border-border/40 md:border-none shadow-none min-h-[400px]">
                   ...
                   <div className="p-8 bg-muted/20 rounded-[2rem] space-y-8 relative overflow-hidden group">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                           <div className="h-10 w-10 rounded-full bg-background flex items-center justify-center shadow-none border border-border/5">
                      ...
                      <Button className="w-full  bg-foreground text-background font-black text-[10px] uppercase h-14 shadow-none tracking-[0.2em] active:scale-95 transition-all">Visualizza Mappa</Button>
                   </div>
                </div>
              </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              <div className="bg-card rounded-[2rem] p-8 flex items-center justify-between border border-border/40 md:border-none shadow-none transition-all hover:scale-[1.01]">
                 <div className="flex items-center gap-5">
              ...
              <button className="bg-card rounded-[2rem] p-8 flex items-center justify-center gap-5 hover:bg-muted/40 transition-all group border border-border/40 md:border-none shadow-none hover:scale-[1.01]">
