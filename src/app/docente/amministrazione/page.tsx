    ...
    <div className="flex flex-col gap-6 pb-10 animate-in fade-in duration-500 pt-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="bg-accent rounded-[2rem] p-5 md:p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-none transition-colors">
            ...
            <Button className="bg-foreground text-background  px-8 h-14 font-black text-base shadow-none hover:opacity-90 transition-all shrink-0">
               Nuova Richiesta
            </Button>
          </div>
          ...
          <div className="bg-card rounded-[2rem] p-8 space-y-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-center justify-between p-5 rounded-[1.5rem] bg-muted/30 hover:bg-muted/50 transition-colors">
        ...
        <div className="lg:col-span-4 space-y-6">
           <div className="bg-card rounded-[2rem] p-8 space-y-8 min-h-full">
              ...
              <div className="space-y-2">
                 {[
                   ...
                   <button key={idx} className="w-full flex items-center justify-between p-4 rounded-[1.5rem] hover:bg-muted/50 transition-all group text-left">
                     <div className="flex items-center gap-3">
