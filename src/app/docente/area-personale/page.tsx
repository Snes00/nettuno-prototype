  ...
  return (
    <div className="flex flex-col gap-6 pb-10 animate-in fade-in duration-500 pt-6">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-12 relative bg-primary text-primary-foreground rounded-[2rem] p-6 md:p-8 overflow-hidden transition-all hover:scale-[1.005]">
          <div className="relative z-10 flex flex-col gap-8">
            <div className="flex justify-between items-start">
              ...
              <Button variant="ghost" className=" h-12 px-6 gap-3 text-primary-foreground/70 hover:bg-primary-foreground/10 font-black uppercase tracking-widest text-[10px] active:scale-95 transition-all shrink-0" asChild>
                <Link href="/">
        ...
        <div className="md:col-span-12">
          <div className="bg-card rounded-[2rem] p-6 md:p-8 space-y-8 border border-border/40 md:border-none shadow-none">
                  ...
                  <div key={campo.label} className="space-y-2">
                    ...
                    {editMode ? (
                      <input
                        ...
                        className="w-full h-14 rounded-[1.5rem] bg-muted/20 border-2 border-primary/20 px-5 font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                      />
                    ) : (
            ...
            {editMode && (
              <div className="flex justify-end pt-4 border-t border-border/20">
                <Button
                  ...
                  className="h-14 px-10 bg-primary text-primary-foreground font-black uppercase tracking-widest text-xs shadow-none active:scale-95"
                >
        ...
        <div className="md:col-span-8 space-y-6">
          <div className="bg-role-accent rounded-[2rem] p-5 md:p-6 space-y-10 border border-role-accent-fg/10 transition-all hover:scale-[1.01]">
            <div className="flex justify-between items-start">
               <div className="space-y-2">
            ...
            <div className="space-y-4">
               {[
                 ...
                 <div key={idx} className="flex items-center justify-between p-6 rounded-[2rem] bg-background/40 dark:bg-black/20 group hover:bg-background/60 transition-all border border-transparent hover:border-role-accent-fg/10">
                    <div className="flex items-center gap-5">
                       <div className="h-12 w-12 rounded-full bg-role-accent-fg/10 flex items-center justify-center font-black text-xs text-role-accent-fg">
                          {ric.nome.charAt(0)}
                       </div>
                       <div>
            ...
            <Button className="w-full bg-role-accent-fg text-role-accent  h-16 font-black uppercase tracking-widest text-xs shadow-none active:scale-95 transition-all">
        ...
        <div className="md:col-span-4 space-y-6">
          <div className="bg-card rounded-[2rem] p-5 md:p-6 space-y-10 border border-border/40 md:border-none shadow-none flex-1 transition-all hover:scale-[1.01]">
             <div className="space-y-2">
             ...
             <div className="space-y-2">
                {[
                  ...
                  <button key={idx} className="w-full flex items-center justify-between p-5 rounded-[1.5rem] hover:bg-muted/40 transition-all group border border-transparent hover:border-border/10">
                    <div className="flex items-center gap-5">
             ...
             <div className="pt-8 border-t border-border/10 space-y-5">
                ...
                <div className="flex gap-4">
                   <button className="h-14 w-14 rounded-full bg-muted/20 flex items-center justify-center hover:bg-muted transition-all active:scale-90"><Camera className="h-6 w-6 text-muted-foreground" /></button>
                   <button className="h-14 w-14 rounded-full bg-muted/20 flex items-center justify-center hover:bg-muted transition-all active:scale-90"><Globe className="h-6 w-6 text-muted-foreground" /></button>
                </div>
             </div>
          </div>
        </div>
